...
const Preview: React.FC<PreviewProps> = ({ formData }) => {
  ...
  return (
    <div className="bg-white shadow-xl p-8 font-serif-jp text-black text-xs leading-normal">
      <div className="w-full">
        <h1 className="text-xl font-bold text-center mb-6">定時株主総会議事録</h1>
        ...
        <div className="mt-4 space-y-4">
          <section>
            <h2 className="font-bold text-base">第１号議案 取締役各個の受けるべき報酬金額決定の件</h2>
            <p className="mt-1">
          ...
          {formData.includeBonusAgenda && (
            <section>
              <h2 className="font-bold text-base">第２号議案 取締役の受けるべき賞与額及び支給日決定の件</h2>
              <p className="mt-1">
